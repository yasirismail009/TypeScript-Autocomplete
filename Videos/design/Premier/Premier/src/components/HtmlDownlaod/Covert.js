  ...
  return (
    <div className="App bg-gray-200 w-full rounded">
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex flex-row ">
              ...
              >
                <img
                  className={fullScreen === false ? "w-28 h-28" : "w-40 h-32"}
        ...
        <div className="flex w-full justify-between items-center py-8 bg-white px-2 mt-4 rounded-xl">
          <Button
            variant="contained"
